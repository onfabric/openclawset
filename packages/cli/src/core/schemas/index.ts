...
export type { PersonalityFile, PersonalityJson, ResolvedPersonality } from '#core/schemas/personality-json.ts';
export { PERSONALITY_AUTO_VARS, PERSONALITY_FILES, personalityJsonSchema } from '#core/schemas/personality-json.ts';
export type {
  RegistryDressEntry,
  RegistryIndex,
